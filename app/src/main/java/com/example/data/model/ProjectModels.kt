...
enum class ExportCodec(val label: String, val description: String) {
  HEVC_H265("H.265 / HEVC", "أقصى كفاءة ضغط مع دقة فائقة 4K"),
  AVC_H264("H.264 / AVC", "توافق قياسي مع كافة المنصات"),
  PRORES_422("Apple ProRes 422", "جودة استوديو إنتاج سينمائي")
}
...
data class ProjectEntity(
  ...
  val assetDrawableName: String,
  val durationMs: Long,
  val resolution: String, // "UHD_4K", "QHD_2K", "FHD_1080P"
  val fps: Int,
  val lastModified: Long = System.currentTimeMillis(),
  val isCloudSynced: Boolean = true,
  val cloudSyncTimestamp: Long = System.currentTimeMillis(),
  val cloudDeviceId: String = "Pixel 9 Pro (This Device)",
  val cloudStorageSizeBytes: Long = 184549376L, // ~184 MB
