...
android {
  namespace = "com.lumina.studio"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.lumina.studio"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  buildTypes {
    release {
      // Minification stays off so behaviour matches debug exactly; enable it
      // together with a real release keystore when publishing.
